...
var filas = [
    ...
    
    {
        ...
        descripcionLarga: 'Domina lo desconocido en la temporada 6. Battlefield™ 2042 es un juego del tipo FPS',
        checked: 'checked',
...

    {
        ...
        descripcionLarga: '¡Asegurate de anotar muchos goles para ganar a todos y ser el mejor del mundo!',
        checked: 'checked',
...

    {
        ...
        descripcionLarga: 'Hogwarts Legacy es un RPG de acción en un mundo abierto. Ahora puedes tomar el control de la acción y ser el centro de tu propia aventura en el mundo mágico.',
        checked: 'checked',
